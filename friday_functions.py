...
def welcome(engine):
    ...
    if hour>=0 and hour<12:
        playsound('./sound/goodmorning.mp3')
    elif hour>=12 and hour<18:
        playsound('./sound/goodafternoon.mp3')
    else:
        playsound('./sound/goodevening.mp3')
...
def record(engine):
	...
	try:
		...
		playsound('./sound/recorgnising_error.mp3')
		return None
	return query
